...
Generated by 'djangocms' command using django CMS 4.1.0 and Django 5.0.3.
...
SECRET_KEY = 'django-insecure-s-*)klmjs-&#758(sgpf&6jst8+e59t^aq8nbzu6ukgthjt1y$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "utilities", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "utilities" / "static",
    os.path.join(BASE_DIR, 'polls_cms_integration/static'),
    os.path.join(BASE_DIR, 'activities_panel/static')
]
